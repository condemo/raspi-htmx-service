...
var file_manager_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x32, 0xec, 0x02, 0x0a, 0x0e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
...
var file_manager_proto_depIdxs = []int32{
	...
	8,  // 12: manager.ServiceManager.GetServices:output_type -> manager.GetServicesResponse
	5,  // 13: manager.ServiceManager.StartService:output_type -> manager.RaspiService
	5,  // 14: manager.ServiceManager.StopService:output_type -> manager.RaspiService
	1,  // 15: manager.ServiceManager.GetFullInfo:output_type -> manager.ServiceFullInfo
	10, // 16: manager.ServiceManager.GetConfig:output_type -> manager.ConfigResponse
